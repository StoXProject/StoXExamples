# Description of example StoX projects for StoX 4.1.0:

## Example_StoX_v4.1.0_acoustic-trawl_sandeel: 
...
## Example_StoX_v4.1.0_acoustic-trawl_sandeel_ResampleBioticAssignmentByAcousticPSU: 
- A copy of the project Example_StoX_v4.1.0_acoustic-trawl_sandeel, but using the new ResampleFunction "ResampleBioticAssignmentByAcousticPSU".

## Example_StoX_v4.1.0_export_ICESAcoustic:
...
## Example_StoX_v4.1.0_export_ICESbiotic:
...
## Example_StoX_v4.1.0_export_IESSNS2015_Eros_accepted_at_ICES: 
...
## Example_StoX_v4.1.0_SpeciesCategoryCatch: 
...
## Example_StoX_v4.1.0_swept-area_cod: 
...
## Example_StoX_v4.1.0_swept-area_cod_total_catch: 
- This project is a copy of the project Example_StoX_v4.1.0_swept-area_cod, but producing total catch estimates instead of length based estimates.

## Example_StoX_v4.1.0_swept-area_translate_maturity: 
