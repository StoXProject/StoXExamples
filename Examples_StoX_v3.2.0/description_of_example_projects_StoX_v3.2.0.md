# Description of example StoX projects for StoX 3.2.0 (the projects are the same as for StoX 3.1.0, except for a change from  SplitMeanNASC to SplitNASC in Example_StoX_v3.2.0_SplitNASC) :
