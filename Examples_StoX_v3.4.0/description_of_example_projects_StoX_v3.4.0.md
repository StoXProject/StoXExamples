# Description of example StoX projects for StoX 3.4.0 (the projects are the same as for StoX 3.1.0, except for a change from  SplitMeanNASC to SplitNASC in Example_StoX_v3.4.0_SplitNASC) :
